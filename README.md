...
This Keras wrapper `ConditionalRecurrent` initiates the internal states of recurrent layers with conditions given as separate inputs. It can be used wuth any recurrent layer supported by Keras and supports wrappers like `Bidirectional`.
